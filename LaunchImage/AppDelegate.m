...
-(void)example1
{
    [XHLaunchAd showWithAdFrame:CGRectMake(0, 0,self.window.bounds.size.width, self.window.bounds.size.height) hideSkip:NO setAdImage:^(XHLaunchAd *launchAd) {
        
        [launchAd imgUrlString:nil duration:5 options:XHWebImageRefreshCached completed:^(UIImage *image, NSURL *url) {
